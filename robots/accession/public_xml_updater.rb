...
module Accession
  ...
  class PublicXmlUpdater
    ...
    def initialize
      LyberCore::Log.set_logfile(File.join(ROBOT_ROOT, "log", "public_xml_updater.log"))
    ...
    # Connects to the message broker and listens for messages 
    def run
      msg_broker_config = {
