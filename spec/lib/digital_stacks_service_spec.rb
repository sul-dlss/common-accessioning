...
describe 'file operations' do
  ...
  describe '.delete_file' do
    it 'deletes a file, but only if it exists and matches the expected signature' do
      ...
      expect(DigitalStacksService.delete_file(file_pathname, moab_signature)).to be_falsey
      ...
      expect(DigitalStacksService.delete_file(file_pathname, moab_signature)).to be_truthy
      expect(file_pathname).not_to exist
    end
  end
  ...
  describe '.rename_file' do
    it 'renames a file, but only if it exists and has the expected signature' do
      ...
      expect(DigitalStacksService.rename_file(old_pathname, new_pathname, moab_signature)).to be_falsey
      # if file exists, but has unexpected signature
      ...
      expect(DigitalStacksService.rename_file(old_pathname, new_pathname, moab_signature)).to be_truthy
      expect(old_pathname).not_to exist
  ...
  describe '.copy_file' do
    it 'copies a file to stacks, but only if it does not yet exist with the expected signature' do
      ...
      expect(DigitalStacksService.copy_file(workspace_pathname, stacks_pathname, moab_signature)).to be_truthy
      # if file exists, and has expected signature
      expect(workspace_pathname).to exist
      ...
      expect(DigitalStacksService.copy_file(workspace_pathname, stacks_pathname, moab_signature)).to be_falsey
      # if file exists, but has unexpected signature
      moab_signature = Moab::FileSignature.new
      expect(workspace_pathname).to exist
      expect(stacks_pathname).to exist
